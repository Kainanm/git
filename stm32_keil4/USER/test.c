...
// 	LCD_ShowString(30,200,200,16,16," Temp:    . C");	
 	...
 	while(1)
	{
		...
		*/
		if(mpu_dmp_get_data(&pitch,&roll,&yaw)==0) // If we get eularian angles, then we get other data
		{ 
			/*
